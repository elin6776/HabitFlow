...
export default function Support() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "On the Home tab, tap the + icon under Daily Tasks and fill out the form.",
    },
    {
      key: "faq3",
      question: "🎯What happens when I complete a challenge?",
      answer:
        "You earn points which appear in the Leaderboard, and your challenge moves to Completed.",
    },
    {
      key: "faq4",
      question: "⏳When are scores reset?",
      answer:
        "Leaderboard scores are automatically reset at the beginning of each month.",
    },
    {
      key: "faq5",
    ...
    },
    {
      ...
      answer:
        "Go to your profile page and tap the avatar to select and upload an image from your device.",
    },
  ];
